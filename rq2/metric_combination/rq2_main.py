from rq2_analysis import rq2_combo
import pandas as pd
import os
...
#data = pd.read_csv(os.path.normpath(os.path.join("rq1", "best_model", "analysis", "analysis_0_1", "best_model_pdg.csv")))
for metric in metrics:
    for repo in repository:
        ...
        rq2_combo(repository=repo, metric_type=metric, best_model = "random_forest")
