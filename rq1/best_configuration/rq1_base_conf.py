...
def train(X, y, method: str, metric_type : int, bal : int, pre : int):
    ...
    pipe = Pipeline([
        ('bal', _search_params["bal"][bal]), # To balance the training data See search_params['bal']
        ('pre', _search_params["pre"][pre]), # To scale (and center) data. See search_params['pre']
